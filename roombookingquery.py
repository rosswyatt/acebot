...
date = raw_input('Choose now, today, tomorrow, this week or next week: ', ) or 0
attendees = raw_input('Number of attendees (leave blank for any): ',) or 0 
length = raw_input('Number of minutes (leave blank for any): ',) or 0
...
git init
git remote add origin https://github.com/vickyhughes/acebot.git
